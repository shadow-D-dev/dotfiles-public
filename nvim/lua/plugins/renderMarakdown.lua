return {
  ...
  init = function()
    local function apply_markdown_highlights()
      ...
      -- local color6_bg = "#5fa9f4"
      -- local color_fg = "#202020"
      -- Gruvbox theme --
      local color1_bg = "#458588" -- blue (gruvbox blue)
      local color2_bg = "#689d6a" -- aqua/green (closest to cyan/teal)
      local color3_bg = "#98971a" -- green
      local color4_bg = "#d79921" -- yellow
      local color5_bg = "#d65d0e" -- orange
      local color6_bg = "#b16286" -- purple
